...
#define NTDEVICE_NAME_STRING      L"\\Device\\HPNonPnpDriver"
#define SYMBOLIC_NAME_STRING     L"\\DosDevices\\HPNonPnpDriver"
...
EVT_WDF_DEVICE_SHUTDOWN_NOTIFICATION NonPnpShutdownG;
